...
private:
  ...
  void StartROS() {
    ...
    impedance_cmd_pub_ = this->create_publisher<plato_interfaces::msg::ImpedanceCommands>(
  ...
  void TickCB() {
    ...
    if (!sorted_positions_.empty() && sorted_positions_.size() >= 8) {
      ...
      plato_interfaces::msg::ImpedanceCommands impedance_cmd;
  ...
  rclcpp::Publisher<plato_interfaces::msg::ImpedanceCommands>::SharedPtr impedance_cmd_pub_;
