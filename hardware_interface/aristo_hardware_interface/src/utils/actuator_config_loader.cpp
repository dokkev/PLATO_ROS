...
char parse_direction(const YAML::Node & node)
{
...
actuator::Limits parse_limits(const YAML::Node & node)
{
  ...
  limits.position_limit_min = parse_float(limits_node, "position_min");
  limits.position_limit_max = parse_float(limits_node, "position_max");
  limits.velocity_limit = parse_float(limits_node, "velocity");
  limits.effort_limit = parse_float(limits_node, "effort");
  limits.stiffness_limit = parse_float(limits_node, "stiffness");
  limits.damping_limit = parse_float(limits_node, "damping");
  return limits;
}
...
Config parse_config(const YAML::Node & node)
{
  ...
  config.core.position_offset = parse_float(node, "position_offset");
