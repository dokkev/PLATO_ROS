...
public:
    ...
    : Node("adaptive_grasp_node"), state_(GraspState::IDLE)
    {
        ...
        cmd_pub_ = this->create_publisher<plato2_interfaces::msg::ImpedanceCommands>(
...
private:
    ...
    void publish_cmd(const std::vector<double>& pos, const std::vector<double>& eff_ff) {
        plato2_interfaces::msg::ImpedanceCommands msg;
        msg.position = pos;
    ...
    rclcpp::Publisher<plato2_interfaces::msg::ImpedanceCommands>::SharedPtr cmd_pub_;
