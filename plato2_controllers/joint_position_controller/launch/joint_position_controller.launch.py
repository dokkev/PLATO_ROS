...
def generate_launch_description():
    pkg_dir = get_package_share_directory('joint_position_controller')
    ...
    default_controller_params = os.path.join(pkg_dir, 'config', 'impedance_presets.yaml')
    ...
    controller_node = Node(
        ...
        executable='joint_position_controller_node',  # Updated controller node
