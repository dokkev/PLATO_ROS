...
colcon build --packages-select plato2_hardware_interface
...
```bash
ros2 launch plato2_hardware_interface aristo_collision_stack.launch.py \
...
```bash
ros2 run plato2_hardware_interface ft_collision_test_node
```
...
```
plato2_hardware_interface/config/ft_collision_test.yaml
```
...
- **FT Sensor Class**: `include/plato2_hardware_interface/ft_sensor_can.hpp`
